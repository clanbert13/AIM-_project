...
#pragma warning disable 649
        ...
        [Tooltip("Rotation speed of the fps controller.")]
        private float mouseSensitivity;
        public Slider sensitivitySlider;
        private float backSensitivity;
...
#pragma warning restore 649
        ...
        private void Start()
        {
            ...
            backSensitivity = PlayerPrefs.GetFloat("backSensitivity", 70f);
            sensitivitySlider.value = backSensitivity;
            mouseSensitivity = Mathf.Round(sensitivitySlider.value) * 0.1f;
        }
			
        public void SensitivitySlider()
        {
            mouseSensitivity = Mathf.Round(sensitivitySlider.value) * 0.1f;
            backSensitivity = Mathf.Round(sensitivitySlider.value);
            PlayerPrefs.SetFloat("backSensitivity", backSensitivity);
        }
        ...
        private void Update()
        {
            sensitivityText.text = "Sensitivity : " + Mathf.Round(sensitivitySlider.value).ToString();
